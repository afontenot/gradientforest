...
void permuteOOBGroup(int m, double *x, int *in, int nsample, int mdim,
 ...
 *   group: grouping array within which to permute
 ...
 */
    ...
    /* this code could be speeded up by moving loop
       over group inside loop over observations and
       having multiple tp,nOOB, one for each group
    */
